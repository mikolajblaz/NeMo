...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="../../../tts_dataset_files/cmudict-0.7b_nv22.07",
    )
    parser.add_argument(
        "--ipa_out",
        help="Path to save IPA version of the dictionary",
        type=str,
        default="../../../tts_dataset_files/ipa-cmudict-0.7b_nv22.07",
    )
    parser.add_argument(
        "--mapping",
...
def convert_cmu_arpabet_to_ipa(arp_ipa_map_file: str, arp_dict_file: str, output_ipa_file: str):
    ...
    print(f"IPA version of {os.path.abspath(arp_dict_file)} saved at {os.path.abspath(output_ipa_file)}")
